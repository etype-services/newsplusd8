...
class ConvertContentTypeCommands extends DrushCommands {
  ...
  public function convert() {
    ...
    // drush_print(print_r($base_table_names, TRUE));
    ...
    // drush_print(print_r($source_bundle_fields, TRUE));
    $db = Database::getConnection();
    foreach ($source_bundle_fields as $field) {
        // drush_print($field->getName());
        
        // can’t get this to work
          // $field_table = $table_mapping->getFieldTableName($field->getName());
          // $field_table = TableMappingInterface::getFieldTableName($field->getName());
